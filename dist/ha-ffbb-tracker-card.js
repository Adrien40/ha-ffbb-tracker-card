            ...
            <div class="modal-body" tabindex="0">
              ${n.length>0?h`
                    <div class="calendar-list">
                      ${n.map((d,f)=>{let k=d.home_team||"-",E=d.away_team||"-",S=d.score||(d.home_score!==void 0?`${d.home_score} - ${d.away_score}`:""),D=this._formatDate(d.date||d.datetime),z=l(k),M=l(E),v=z||M,$=!!(d.is_played||S),w=f===u,b=Ee({teamName:k,matchLogo:d.home_logo||d.home_team_logo,isMyTeam:z,myTeamLogo:p,nextOpponentState:e.nextOpponent?.state,nextOpponentLogo:e.nextOpponent?.attributes?.opponent_logo_url,lastOpponentState:e.lastOpponent?.state,lastOpponentLogo:e.lastOpponent?.attributes?.opponent_logo_url,standings:i}),oe=Ee({teamName:E,matchLogo:d.away_logo||d.away_team_logo,isMyTeam:M,myTeamLogo:p,nextOpponentState:e.nextOpponent?.state,nextOpponentLogo:e.nextOpponent?.attributes?.opponent_logo_url,lastOpponentState:e.lastOpponent?.state,lastOpponentLogo:e.lastOpponent?.attributes?.opponent_logo_url,standings:i}),x="";return z?x="DOM":M&&(x="EXT"),h`
                          <div
