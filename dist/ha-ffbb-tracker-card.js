        ...
        <div class="team-logo-cell cell-left">
          ...
          >
            <img
              ...
              src=${u}
              alt=""
              @error=${C=>{C.target.src.endsWith(F)||(C.target.src=F)}}
            />
          </div>
        </div>
