...
`;var Je=class extends T{static get properties(){return{hass:{attribute:!1},_config:{state:!0},_translations:{state:!0}}}static get styles(){return ee`
      .card-version {
        text-align: right;
        font-size: 0.75em;
        font-weight: 500;
            ...
            <div class="modal-body" tabindex="0">
              ${r.length>0?h`
                    <table class="standings-table">
                      ...
                      <tbody>
                        ${r.map(i=>{let m=i.team_name||i.name||"",g=c(m)||u(m);return h`
            ...
            <div class="modal-body" tabindex="0">
              ${o.length>0?h`
                    <div class="calendar-list">
                      ${o.map(c=>{let u=c.home_team||c.equipe_domicile||"-",i=c.away_team||c.equipe_exterieur||"-",m=c.score||(c.home_score!==void 0?`${c.home_score} - ${c.away_score}`:""),g=this._formatDate(c.date||c.datetime),w=l(u),E=l(i);return h`
                          <div class="calendar-row ${w||E?"highlight-row":""}">
                            ...
                            <div class="calendar-col-meta">
                              ${m?h`<div class="cal-score">${m}</div>`:g?h`
    ...
    `}_renderMatchHeader(e){let{competition:t,pouleName:a,roundNumber:o}=e;return h`
      ${this._config.show_header?h`
          ...
          `:""}
    `}_renderMatchArea(e){let{isLive:t,canToggleView:a,isPostMatch:o,isGameDay:r,leftName:s,rightName:d,leftLogo:l,rightLogo:c,leftUrl:u,rightUrl:i,leftEntityId:m,rightEntityId:g,gymName:w,gymCity:E,dateFormatted:C,logoSizeClass:B,showRank:ue,leftRank:L,rightRank:b,isCalendarClickable:$,isLogoClickable:x,hasStandingsData:v}=e,k=this._config?.rank_badge_style==="solid"||!!this._config?.solid_rank_badges?"rank-solid":"";return h`
        ...
        <div class="team-logo-cell cell-left">
          ...
          >
            <img
              ...
              src=${l}
              alt=""
              @error=${V=>{V.target.src.endsWith(A)||(V.target.src=A)}}
            />
          </div>
        </div>
