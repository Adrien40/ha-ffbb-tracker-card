...
`;var ia=["unknown","unavailable"];function vo(a,e){let t=A(a?.team_name||a?.name||""),o=A(e);return!t||!o?!1:t.includes(o)||o.includes(t)}function la(a){return a==null||a===""?"-":a}function xo(a){if(a==null||a==="")return"-";let e=Number(a);return Number.isFinite(e)?e>0?`+${e}`:String(e):a}function yo(a){let e=Number(a);return a==null||a===""||!Number.isFinite(e)||e===0?"":e>0?"diff-pos":"diff-neg"}var wo={matches:[{key:"table_played",fb:"J",full:"table_played_full",fullFb:"Games played",get:a=>a.played},{key:"table_wins",fb:"G",full:"table_wins_full",fullFb:"Wins",get:a=>a.wins??a.won},{key:"table_losses",fb:"P",full:"table_losses_full",fullFb:"Losses",get:a=>a.losses??a.lost},{key:"table_draws",fb:"N",full:"table_draws_full",fullFb:"Draws",get:a=>a.draws}],singles:[{key:"table_irregularities",fb:"I",full:"table_irregularities_full",fullFb:"Irregularities",get:a=>a.irregularities},{key:"table_penalties",fb:"P\xE9n.",full:"table_penalties_full",fullFb:"Penalties",get:a=>a.total_penalties},{key:"table_forfeits",fb:"For.",full:"table_forfeits_full",fullFb:"Forfeits",get:a=>a.forfeits},{key:"table_defaults",fb:"D\xE9f.",full:"table_defaults_full",fullFb:"Defaults",get:a=>a.defaults}],penalties:[{key:"table_referee",fb:"Arb",full:"table_referee_full",fullFb:"Referee penalties",get:a=>a.referee_penalties},{key:"table_coach",fb:"Ent",full:"table_coach_full",fullFb:"Coach penalties",get:a=>a.coach_penalties}],points:[{key:"table_scored",fb:"M",full:"table_scored_full",fullFb:"Points scored",get:a=>a.points_for},{key:"table_conceded",fb:"E",full:"table_conceded_full",fullFb:"Points conceded",get:a=>a.points_against},{key:"table_diff",fb:"D",full:"table_diff_full",fullFb:"Points difference",get:a=>a.points_diff,signed:!0}]};function ct(a,e=!0){return e?c`
    ...
    />
  `:g}function dt({rows:a,teamName:e,displayTeamName:t,t:o,showLogos:n=!0}){let{matches:s,singles:r,penalties:d,points:l}=wo,u=i=>o(`card.${i.key}`,i.fb),p=i=>o(`card.${i.full}`,i.fullFb),h=i=>c`<th class="sub-head" scope="col"><abbr title=${p(i)}>${u(i)}</abbr></th>`,f=(i,_)=>{let y=i.get(_);return i.signed?c`<td class="num ${yo(y)}">${xo(y)}</td>`:c`<td class="num">${la(y)}</td>`};return c`
    <div class="standings-scroll">
      <table class="standings-table standings-table-detailed">
        ...
        <tbody>
          ${a.map(i=>{let _=vo(i,e),y=_&&t?t:i.team_name||i.name||"-";return c`
              <tr class=${_?"highlight-row":""}>
                <td class="pos-cell col-pos">${i.position||i.rank||"-"}</td>
                <td class="col-team">${ct(i.logo_url,n)}<span>${y}</span></td>
  ...
  `}function ca({standings:a,poule:e,competition:t,teamName:o,displayTeamName:n,accentColor:s,title:r,icon:d,compact:l,showLogos:u=!0,t:p}){let h=Te(a),f=e&&!ia.includes(e)?e:"",i=t&&!ia.includes(t)?t:"",_=r||p("card.standings_title","Standings"),y=d!==void 0?d:"mdi:format-list-numbered";return c`
    <ha-card class="standings-card ${l?"standings-compact":""}" style="--ffbb-accent-color: ${s};">
      <div class="standings-card-header">
        ${y?c`<ha-icon icon=${y}></ha-icon>`:g}
        <span>${_}${f?` \u2022 ${f}`:""}</span>
      </div>
...
`;var ht=class extends P{static get properties(){return{hass:{attribute:!1},_config:{state:!0},_translations:{state:!0}}}static get styles(){return q`
          ...
          >
            ...
            <div class="modal-body" tabindex="0">
              ${r.length===0?c`
                  ...
                  `:f?dt({rows:r,teamName:t,displayTeamName:n,t:(i,_)=>this._t(i,_),showLogos:this._config.show_list_logos!==!1}):c`
                    <table class="standings-table">
                      ...
                      <tbody>
                        ${r.map(i=>{let _=i.team_name||i.name||"",y=p(_),x=y||h(_),T=y&&n?n:i.team_name||i.name||"-";return c`
                            <tr class=${x?"highlight-row":""}>
                              <td class="pos-cell">${i.position||i.rank||"-"}</td>
                              <td class="col-team">${ct(i.logo_url,this._config.show_list_logos!==!1)}<span>${T}</span></td>
            ...
            <div class="modal-body" tabindex="0">
              ${s.length>0?c`
                    <div class="calendar-list">
                      ${s.map((i,_)=>{let y=i.home_team||"-",x=i.away_team||"-",T=i.score||(i.home_score!==void 0?`${i.home_score} - ${i.away_score}`:""),F=this._formatDate(i.date||i.datetime),M=u(y),b=u(x),C=M||b,$=!!(i.is_played||T),w=_===p,oe=De({teamName:y,matchLogo:i.home_logo||i.home_team_logo,isMyTeam:M,myTeamLogo:h,nextOpponentState:e.nextOpponent?.state,nextOpponentLogo:e.nextOpponent?.attributes?.opponent_logo_url,lastOpponentState:e.lastOpponent?.state,lastOpponentLogo:e.lastOpponent?.attributes?.opponent_logo_url,standings:f}),E=De({teamName:x,matchLogo:i.away_logo||i.away_team_logo,isMyTeam:b,myTeamLogo:h,nextOpponentState:e.nextOpponent?.state,nextOpponentLogo:e.nextOpponent?.attributes?.opponent_logo_url,lastOpponentState:e.lastOpponent?.state,lastOpponentLogo:e.lastOpponent?.attributes?.opponent_logo_url,standings:f}),D="";return M?D="DOM":b&&(D="EXT"),c`
                          <div
                            class="calendar-row ${C?"highlight-row":""} ${w?"next-match-row":""}"
                            @click=${()=>this._selectCalendarMatch(_,$)}
                            @keydown=${this._onKeyActivate(()=>this._selectCalendarMatch(_,$))}
                            role="button"
                            tabindex="0"
                            aria-label="${M&&n?n:y} vs ${b&&n?n:x}"
                          >
                            ...
                            <div class="calendar-col-teams">
                              <div class="cal-team-line">
                                ${this._config.show_list_logos!==!1?c`
                                      <img
                                        class="cal-mini-logo"
                                        src=${oe}
                                        alt=""
    ...
    `}_renderMatchHeader(e){let{competition:t,pouleName:o,roundNumber:n}=e;return c`
      ${this._config.show_header?c`
          ...
          `:""}
    `}_renderMatchArea(e){let{isLive:t,canToggleView:o,isPostMatch:n,isGameDay:s,leftName:r,rightName:d,leftLogo:l,rightLogo:u,leftUrl:p,rightUrl:h,leftEntityId:f,rightEntityId:i,gymName:_,gymCity:y,dateFormatted:x,logoSizeClass:T,showRank:F,leftRank:M,rightRank:b,isCalendarClickable:C,isLogoClickable:$,hasStandingsData:w}=e,E=this._config?.rank_badge_style==="solid"?"rank-solid":"";return c`
      <div class="match-area">
        ...
        <div class="center-meta-wrapper">
          ...
          <div
            ...
            @click=${()=>{C&&this._openCalendar(e.targetDateStr,r,d,_,y)}}
            @keydown=${C?this._onKeyActivate(()=>this._openCalendar(e.targetDateStr,r,d,_,y)):g}
            role=${C?"button":g}
            tabindex=${C?"0":g}
        ...
        ${F&&(M||b)?c`
              <div class="team-rank-cell rank-left">
                ${M?c`
                      <span
                        class="rank-badge ${this._getRankClass(M)} ${E} ${w?"clickable-badge":""}"
                        @click=${()=>{w&&this._openModal("standings")}}
                        @keydown=${w?this._onKeyActivate(()=>this._openModal("standings")):g}
                        role=${w?"button":g}
                        tabindex=${w?"0":g}
                        aria-label=${w?this._t("card.view_standings","View league standings"):g}
                        title=${w?this._t("card.view_standings","View league standings"):""}
                      >${M}</span>
                    `:""}
              </div>
              <div class="team-rank-cell rank-right">
                ${b?c`
                      <span
                        class="rank-badge ${this._getRankClass(b)} ${E} ${w?"clickable-badge":""}"
                        @click=${()=>{w&&this._openModal("standings")}}
                        @keydown=${w?this._onKeyActivate(()=>this._openModal("standings")):g}
                        role=${w?"button":g}
                        tabindex=${w?"0":g}
