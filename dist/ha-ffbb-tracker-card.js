...
`;var ra=["unknown","unavailable"];function bo(a,e){let t=k(a?.team_name||a?.name||""),o=k(e);return!t||!o?!1:t.includes(o)||o.includes(t)}function ia(a){return a==null||a===""?"-":a}function vo(a){if(a==null||a==="")return"-";let e=Number(a);return Number.isFinite(e)?e>0?`+${e}`:String(e):a}function xo(a){let e=Number(a);return a==null||a===""||!Number.isFinite(e)||e===0?"":e>0?"diff-pos":"diff-neg"}var yo={matches:[{key:"table_played",fb:"J",full:"table_played_full",fullFb:"Games played",get:a=>a.played},{key:"table_wins",fb:"G",full:"table_wins_full",fullFb:"Wins",get:a=>a.wins??a.won},{key:"table_losses",fb:"P",full:"table_losses_full",fullFb:"Losses",get:a=>a.losses??a.lost},{key:"table_draws",fb:"N",full:"table_draws_full",fullFb:"Draws",get:a=>a.draws}],singles:[{key:"table_irregularities",fb:"I",full:"table_irregularities_full",fullFb:"Irregularities",get:a=>a.irregularities},{key:"table_penalties",fb:"P\xE9n.",full:"table_penalties_full",fullFb:"Penalties",get:a=>a.total_penalties},{key:"table_forfeits",fb:"For.",full:"table_forfeits_full",fullFb:"Forfeits",get:a=>a.forfeits},{key:"table_defaults",fb:"D\xE9f.",full:"table_defaults_full",fullFb:"Defaults",get:a=>a.defaults}],penalties:[{key:"table_referee",fb:"Arb",full:"table_referee_full",fullFb:"Referee penalties",get:a=>a.referee_penalties},{key:"table_coach",fb:"Ent",full:"table_coach_full",fullFb:"Coach penalties",get:a=>a.coach_penalties}],points:[{key:"table_scored",fb:"M",full:"table_scored_full",fullFb:"Points scored",get:a=>a.points_for},{key:"table_conceded",fb:"E",full:"table_conceded_full",fullFb:"Points conceded",get:a=>a.points_against},{key:"table_diff",fb:"D",full:"table_diff_full",fullFb:"Points difference",get:a=>a.points_diff,signed:!0}]};function ct({rows:a,teamName:e,displayTeamName:t,t:o}){let{matches:n,singles:s,penalties:r,points:c}=yo,i=d=>o(`card.${d.key}`,d.fb),u=d=>o(`card.${d.full}`,d.fullFb),f=d=>h`<th class="sub-head" scope="col"><abbr title=${u(d)}>${i(d)}</abbr></th>`,p=(d,l)=>{let g=d.get(l);return d.signed?h`<td class="num ${xo(g)}">${vo(g)}</td>`:h`<td class="num">${ia(g)}</td>`};return h`
    <div class="standings-scroll">
      <table class="standings-table standings-table-detailed">
        ...
        <tbody>
          ${a.map(d=>{let l=bo(d,e),g=l&&t?t:d.team_name||d.name||"-";return h`
              <tr class=${l?"highlight-row":""}>
                <td class="pos-cell col-pos">${d.position||d.rank||"-"}</td>
                <td class="col-team">${g}</td>
                <td class="pts-cell">${ia(d.points??d.pts)}</td>
                ${n.map(x=>p(x,d))}
                ${s.map(x=>p(x,d))}
                ${r.map(x=>p(x,d))}
                ${c.map(x=>p(x,d))}
  ...
  `}function la({standings:a,poule:e,competition:t,teamName:o,displayTeamName:n,accentColor:s,title:r,icon:c,compact:i,t:u}){let f=De(a),p=e&&!ra.includes(e)?e:"",d=t&&!ra.includes(t)?t:"",l=r||u("card.standings_title","Standings"),g=c!==void 0?c:"mdi:format-list-numbered";return h`
    <ha-card class="standings-card ${i?"standings-compact":""}" style="--ffbb-accent-color: ${s};">
      ...
      <div class="standings-card-body">
        ${f.length>0?ct({rows:f,teamName:o,displayTeamName:n,t:u}):h`<div class="standings-empty-text">${u("card.no_standings","No standings data available.")}</div>`}
      </div>
    </ha-card>
  `}var ca=q`
  .standings-card {
...
`;var dt=class extends P{static get properties(){return{hass:{attribute:!1},_config:{state:!0},_translations:{state:!0}}}static get styles(){return q`
      .card-version {
        text-align: right;
        font-size: 0.75em;
        font-weight: 500;
    ...
    `}};customElements.get("ffbb-tracker-card-editor")||customElements.define("ffbb-tracker-card-editor",dt);var ht=class extends P{static get properties(){return{hass:{attribute:!1},_config:{state:!0},_activeModal:{state:!0},_manualView:{state:!0},_matchIndex:{state:!0}}}constructor(){super(),this._translationsLang="en",this._translations=ae("en"),this._activeModal=null,this._manualView=null,this._matchIndex=null,this._modalTrigger=null}static async getConfigElement(){return document.createElement("ffbb-tracker-card-editor")}static getStubConfig(){return{entity:"",...ye}}getCardSize(){let e=this._config?this._resolveEntities():null;return Qt({config:this._config,standings:e?.rank?.attributes?.standings})}getGridOptions(){return{columns:12,min_columns:9,min_rows:3}}setConfig(e){if(!e.entity)throw new Error("Please define an entity from the FFBB Tracker integration.");this._config={...ye,...e},this._warnIfInvalidAccentColor()}_warnIfInvalidAccentColor(){let{accent_color:e,custom_accent_color:t}=this._config,o=String(t??"").trim();e!=="custom"||!o||we(o)||this._warnedAccentColor!==o&&(this._warnedAccentColor=o,console.warn(`[FFBB Tracker Card] custom_accent_color "${o}" is not a valid CSS color (use e.g. #1e88e5 or "blue"): the default orange is used.`))}willUpdate(e){if(super.willUpdate(e),e.has("hass")&&this.hass){let t=Te(this.hass);t!==this._translationsLang&&(this._translationsLang=t,this._translations=ae(t))}}_t(e,t=""){return Ne(this._translations,e,t)}_colon(){return this._translationsLang==="fr"?"\xA0:":":"}_getRankClass(e){if(!e||this._config?.rank_badge_style==="none")return"";let o=String(e).trim().match(/^(\d+)/);if(!o)return"";let n=parseInt(o[1],10);return n===1?"rank-gold":n===2?"rank-silver":n===3?"rank-bronze":""}_resolveEntities(){return Yt(this._config.entity,this.hass?.states)}_localeInfo(){let e=this.hass?.locale?.language||this.hass?.language||"en-US";return{language:e,hour12:ea(this.hass?.locale?.time_format,e)}}_formatDate(e){let{language:t,hour12:o}=this._localeInfo();return lt(e,t,{hour12:o})}_openMaps(e,t){let o=encodeURIComponent(`${e} ${t}`.trim());window.open(`https://www.google.com/maps/search/?api=1&query=${o}`,"_blank","noreferrer")}_openCalendar(e,t,o,n,s){if(!e||e==="unknown"||e==="unavailable")return;let r=new Date(e);if(isNaN(r.getTime()))return;let c=new Date(r.getTime()+7200*1e3),i=l=>l.toISOString().replace(/[-:]|\.\d{3}/g,""),u=`${t} vs ${o}`,f=`${n} ${s}`.trim(),p=this._t("card.calendar_details","FFBB match: {home} vs {away}").replace("{home}",t).replace("{away}",o),d=`https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(u)}&dates=${i(r)}/${i(c)}&details=${encodeURIComponent(p)}&location=${encodeURIComponent(f)}`;window.open(d,"_blank","noreferrer")}_handleLogoClick(e,t,o){let n=this._config.logo_click_action||"team_url";n==="team_url"?t?window.open(t,"_blank","noreferrer"):(console.warn(`[FFBB Tracker Card] No URL found for team: "${o}".`),e&&this._fireMoreInfo(e)):n==="more-info"&&e&&this._fireMoreInfo(e)}_fireMoreInfo(e){let t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e}});this.dispatchEvent(t)}_openModal(e){this._modalTrigger=this.shadowRoot?.activeElement??null,this._activeModal=e}_closeModal(){this._activeModal=null}updated(e){if(super.updated(e),!e.has("_activeModal"))return;let t=e.get("_activeModal");if(this._activeModal&&!t)this.shadowRoot?.querySelector(".modal-card")?.focus();else if(!this._activeModal&&t){let o=this._modalTrigger;this._modalTrigger=null,o&&o.isConnected&&typeof o.focus=="function"&&o.focus()}}_onModalKeydown(e){if(e.key==="Escape"){e.stopPropagation(),this._closeModal();return}if(e.key!=="Tab")return;let t=e.currentTarget.querySelector(".modal-card");if(!t)return;let o=[...t.querySelectorAll('[tabindex]:not([tabindex="-1"])')];if(o.length===0){e.preventDefault(),t.focus();return}let n=o[0],s=o[o.length-1],r=this.shadowRoot?.activeElement;e.shiftKey&&(r===n||r===t)?(e.preventDefault(),s.focus()):!e.shiftKey&&r===s&&(e.preventDefault(),n.focus())}_setManualView(e){this._manualView=e,this._matchIndex=null}_handleChevronClick(e,t){if(t.hasCalendar&&t.calendarMatches.length>1){let o=e==="prev"?t.currentIndex-1:t.currentIndex+1;if(o>=0&&o<t.calendarMatches.length){this._matchIndex=o;let n=t.calendarMatches[o];this._manualView=n.is_played||n.score?"last":"next"}}else this._setManualView(e==="prev"?"last":"next")}_selectCalendarMatch(e,t){this._matchIndex=e,this._manualView=t?"last":"next",this._closeModal()}_onKeyActivate(e){return t=>{(t.key==="Enter"||t.key===" "||t.key==="Spacebar")&&(t.preventDefault(),e())}}_extractCalendarMatches(e){let t=this._config.entity?this.hass?.states[this._config.entity]:null;return it(e,t)}_renderModal(e,t,o,n){if(!this._activeModal)return h``;if(this._activeModal==="standings"){let s=e.rank?.attributes?.standings||[],r=De(s),c=e.poule?.attributes?.competition||"",i=e.poule?.state||"",u=r.map(l=>l.team_name||l.name||""),f=Ee(u,t),p=Ee(u,o),d=!!this._config?.standings_popup_detailed;return h`
          ...
          >
            ...
            <div class="modal-body" tabindex="0">
              ${r.length===0?h`
                  ...
                  `:d?ct({rows:r,teamName:t,displayTeamName:n,t:(l,g)=>this._t(l,g)}):h`
                    <table class="standings-table">
                      ...
                      <tbody>
                        ${r.map(l=>{let g=l.team_name||l.name||"",x=f(g),A=x||p(g),D=x&&n?n:l.team_name||l.name||"-";return h`
            ...
            <div class="modal-body" tabindex="0">
              ${s.length>0?h`
                    <div class="calendar-list">
                      ${s.map((l,g)=>{let x=l.home_team||"-",A=l.away_team||"-",D=l.score||(l.home_score!==void 0?`${l.home_score} - ${l.away_score}`:""),F=this._formatDate(l.date||l.datetime),C=u(x),b=u(A),S=C||b,w=!!(l.is_played||D),y=g===f,oe=Oe({teamName:x,matchLogo:l.home_logo||l.home_team_logo,isMyTeam:C,myTeamLogo:p,nextOpponentState:e.nextOpponent?.state,nextOpponentLogo:e.nextOpponent?.attributes?.opponent_logo_url,lastOpponentState:e.lastOpponent?.state,lastOpponentLogo:e.lastOpponent?.attributes?.opponent_logo_url,standings:d}),M=Oe({teamName:A,matchLogo:l.away_logo||l.away_team_logo,isMyTeam:b,myTeamLogo:p,nextOpponentState:e.nextOpponent?.state,nextOpponentLogo:e.nextOpponent?.attributes?.opponent_logo_url,lastOpponentState:e.lastOpponent?.state,lastOpponentLogo:e.lastOpponent?.attributes?.opponent_logo_url,standings:d}),O="";return C?O="DOM":b&&(O="EXT"),h`
                          <div
                          ...
                          >
                            ...
                            <div class="calendar-col-meta">
                              ${D?h`
                                    <div class="cal-score">
                                      ${(()=>{let _=S?rt(D,C):null;return _?h`<span class="score-mine">${_.my}</span
                                              ><span class="score-sep"> - </span
                                              ><span class="score-theirs">${_.opponent}</span>`:D})()}
                                    </div>
                                  `:F?h`
      ...
      `}return h``}_computeViewModel(e){let{language:t,hour12:o}=this._localeInfo();return ta({entities:e,config:this._config,manualView:this._manualView,matchIndex:this._matchIndex,states:this.hass?.states,lang:this._translationsLang,locale:t,hour12:o,t:(n,s)=>this._t(n,s),isPreview:!!(this.preview||this.parentElement?.tagName==="HUI-CARD-PREVIEW"||this.closest&&this.closest("hui-card-preview"))})}render(){if(!this.hass||!this._config)return h``;let e=this._resolveEntities();if(!e)return h`
      ...
      ${t.displayMode!=="match"?la({standings:e.rank?.attributes?.standings,poule:e.poule?.state,competition:e.poule?.attributes?.competition,teamName:t.searchTeamName,displayTeamName:t.configuredTeamName,accentColor:t.accentColor,title:t.standingsTitle,icon:t.standingsIcon,compact:t.displayMode==="both",t:(o,n)=>this._t(o,n)}):m}
    ...
    `}_renderMatchHeader(e){let{competition:t,pouleName:o,roundNumber:n}=e;return h`
      ${this._config.show_header?h`
          ...
          `:""}
    `}_renderMatchArea(e){let{isLive:t,canToggleView:o,isPostMatch:n,isGameDay:s,leftName:r,rightName:c,leftLogo:i,rightLogo:u,leftUrl:f,rightUrl:p,leftEntityId:d,rightEntityId:l,gymName:g,gymCity:x,dateFormatted:A,logoSizeClass:D,showRank:F,leftRank:C,rightRank:b,isCalendarClickable:S,isLogoClickable:w,hasStandingsData:y}=e,M=this._config?.rank_badge_style==="solid"?"rank-solid":"";return h`
      <div class="match-area">
        ...
        <div class="center-meta-wrapper">
          ...
          <div
            ...
            @click=${()=>{S&&this._openCalendar(e.targetDateStr,r,c,g,x)}}
            @keydown=${S?this._onKeyActivate(()=>this._openCalendar(e.targetDateStr,r,c,g,x)):m}
            role=${S?"button":m}
            tabindex=${S?"0":m}
    ...
    `}_renderFooter(e){let{gymName:t,gymCity:o,hasValidForm:n,isPreview:s,displayFormSequence:r,displayFormStreak:c,showFormBlock:i}=e;return h`
      ...
      ${this._config.show_venue&&(t||o)?h`
          ...
          `:""}
    `}static get styles(){return[sa,ca]}};customElements.get("ffbb-tracker-card")||customElements.define("ffbb-tracker-card",ht);console.info(`%c FFBB Tracker Card %c v${xe} `,"color: white; background: #e02424; font-weight: 700; border-radius: 3px 0 0 3px;","color: #e02424; background: white; font-weight: 700; border-radius: 0 3px 3px 0;");window.customCards=window.customCards||[];var da=window.customCards.findIndex(a=>a.type==="ffbb-tracker-card"),ha={type:"ffbb-tracker-card",name:`FFBB Tracker v${xe}`,preview:!0,description:"Display French Basketball Federation match schedules, live scores, and gym venue."};da!==-1?window.customCards[da]=ha:window.customCards.push(ha);
